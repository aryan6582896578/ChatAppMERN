...
export function MemberListComponent({memberListSMDisplay}){
  ...
  useEffect(() => {
    ...
    return(
      //   <div className={`bg-primaryColor text-otherColor h-[100%]  min-w-[150px] max-w-[150px] sm:max-w-[250px] sm:min-w-[250px] border-solid border-l-[1px] border-secondaryColor ${memberListSMDisplay} sm:block  `}>
      ...
      // </div>
      <div className="h-[100%] w-fit bg-primaryColor flex flex-col">
