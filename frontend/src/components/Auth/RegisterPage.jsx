        ...
        <div className="bg-primaryColor min-h-screen w-full overflow-hidden text-textColor   ">
          ...
          <div className="flex flex-col bg-secondaryColor mt-[60px] ml-[5%] mr-[5%] h-fit rounded-[5px] sm:w-[450px] sm:ml-auto sm:mr-auto">
            ...
            <div className="flex flex-col mb-[5px] p-[10px]">
              <div className="text-[13px] mb-[5px] font-semibold text-otherColor text-opacity-[80%]">USERNAME 
            ...
            <div className="flex flex-col">
              <button onClick={() => {registerCheck();}} className="bg-textColor text-otherColor text-[20px]  ml-[10px] mr-[10px] mt-[5px] p-[5px] rounded-[5px] font-semibold border-[2px] border-textColor hover:bg-transparent duration-[0.5s]">
                  Register
              </button>   
              <div>
                <button className="text-otherColor opacity-[70%] hover:underline hover:text-otherColor duration-[0.5s] ml-[10px] mb-[5px] mt-[5px] hover:opacity-[100%]" onClick={()=>{navigate(`/${import.meta.env.VITE_VERSION}/login`)}}>Login?</button>
              </div>
            </div>
            </div>
        </div>
