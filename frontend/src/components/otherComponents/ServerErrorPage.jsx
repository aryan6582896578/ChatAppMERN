...
export default function ServerErrorPage(){
    ...
    return(
        <div className="bg-secondaryColor w-screen min-h-screen flex flex-col text-otherColor overflow-hidden">
            <div className="bg-primaryColor h-[70px] w-[100%] relative flex border-b-otherColor border-opacity-[80%] border-b-[1px]">
            ...
            <div className="mt-[180px] sm:mt-[150px]">
                ...
                <div className="font-bold text-[40px] text-center text-red-500 align-middle sm:text-[50px]"> <span className="animate-pulse">Error 500 </span><div className="text-[20px] sm:text-[30px] ">Internal Server Error <span className="text-otherColor font-medium underline opacity-[90%] hover:cursor-pointer hover:text-textColor sm:text-[25px]" onClick={()=>{
                    location.reload()
                }}>Reload?</span></div></div>
